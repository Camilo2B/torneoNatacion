...
public class ResultadosViewController {
    ...
    @FXML
    private Label tiempoGanadorLabel;
    ...
    public void mostrarGanador() {
        if (participantes != null && !participantes.isEmpty()) {
            Participante ganador = Clasificacion.determinarGanador(participantes);
            if (ganador != null) {
                ganadorLabel.setText("Ganador: " + ganador.getNombre());
                tiempoGanadorLabel.setText("Tiempo: " + ganador.getTiempo().toString());
            } else {
                ganadorLabel.setText("No hay ganador");
                tiempoGanadorLabel.setText("");
            }
        } else {
            ganadorLabel.setText("No hay participantes");
            tiempoGanadorLabel.setText("");
        }
    }
